...
API_ID = "21609142" 
API_HASH = "8ba7b8089f92d6349d975618498858a7" 
...
async def check_password(client, message):
    if message.reply_to_message and "🔑 পাসওয়ার্ড ভেরিফিকেশন" in message.reply_to_message.text:
        if message.text.strip() == APP_PASSWORD:
            ...
            await message.reply_text(f"🚫 পাসওয়ার্ড ভুল! সঠিক পাসওয়ার্ডের জন্য {MY_ID_NAME} কে মেসেজ দিন।")
...
print("বটটি নতুন ওয়েলকাম মেসেজসহ অনলাইনে আছে...")
app.run()
