...
def start(message):
    ...
    welcome_text = (
        "✨ **BOSS ENAFUL ব্রডকাস্ট বটে আপনাকে স্বাগতম!** ✨\n\n"
        "এই বটের মাধ্যমে আপনি যা যা করতে পারবেন:\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        "✅ **Latest Updates:** সবার আগে নতুন অ্যাপ ও ফাইল পাবেন।\n"
        "📦 **Direct APK:** সরাসরি ইনবক্সে মোড করা APK পাবেন।\n"
        "🚀 **Fast Access:** খুব সহজে নতুন প্রজেক্ট ডাউনলোড করতে পারবেন।\n"
        "📞 **Support:** সরাসরি অ্যাডমিনের সাথে যোগাযোগ করার সুবিধা।\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
...
def handle_menu(message):
    if message.chat.id == ADMIN_ID:
        if message.text == '📊 Full Stats':
            ...
            msg = bot.send_message(message.chat.id, "📁 আপনি যা ব্রডকাস্ট করতে চান (APK/ফাইল/টেক্সট) তা এখানে দিন।", reply_markup=cancel_menu())
            ...
            msg = bot.send_message(message.chat.id, "লিস্ট থেকে যে আইডিটি সরাতে চান তা দিন:", reply_markup=cancel_menu())
    ...
    if message.text == '💬 Contact Admin':
        bot.reply_to(message, "👨‍💻 অ্যাডমিনের সাথে যোগাযোগ করুন: @BOSS_ENAFUL")
    
    elif message.text == 'ℹ️ About Bot':
        about_text = (
            "🤖 **Cyber 71 Enaful Assistant**\n\n"
            "👤 **মালিক:** BOSS ENAFUL\n"
            "🛠 **ডেভেলপার:** Python & Termux Expert\n"
            "📡 **ভার্সন:** v2.5 (Adjusted)\n\n"
            "এটি একটি অ্যাডভান্সড ব্রডকাস্ট ম্যানেজমেন্ট বট।"
        )
...
def process_remove_user(message):
    ...
    if remove_user_from_db(message.text):
        ...
        bot.reply_to(message, "❌ এই আইডিটি লিস্টে পাওয়া যায়নি।", reply_markup=admin_tools_menu())
...
def start_broadcasting(message):
    ...
    bot.send_message(ADMIN_ID, f"✅ ব্রডকাস্ট সম্পন্ন!\n\nসফল: {success}\nব্যর্থ (Block): {failed}", reply_markup=main_menu())

print("বটটি সফলভাবে চালু হয়েছে (BOSS ENAFUL Edition)...")
bot.polling()
